...
def upload_audio(audio_path, sample_rate):
...
def success():  
    if request.method == 'POST':  
        ...
        f.save(f.filename)
        audio = upload_audio(f.filename,sample_rate=SAMPLE_RATE)
        est_ns = inference_model(audio)
        note_seq.sequence_proto_to_midi_file(est_ns, f'static/{f.filename}.mid')
